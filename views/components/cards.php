...
<a href="<?php echo BASE_URL; ?>controllers/controller_product.php?id=<?php echo $category['id']; ?>"
    class="block h-full">
    ...
    <div
        ...
        <div class="catalog-img-container bg-white w-full h-72">
            <img src="<?php echo BASE_URL . $imagenMostrar; ?>" alt="<?php echo $category['name']; ?>"
        ...
        <div class="p-6 text-center">
            ...
            <p class="text-sm text-white/90 text-center line-clamp-2">

...
<head>
    ...
    <meta name="description"
        content="Productos de embalaje, empaques y soluciones adaptadas a empresas, comercio y logística en San Luis Potosí." />
...
<body class="font-body antialiased">
    ...
    <div class="flex flex-col min-h-screen">
        <header
            ...
            <div class="container header-container flex h-14 items-center justify-between">
                ...
                <nav class="hidden flex-1 items-center space-x-6 text-sm font-medium md:flex">
                    ...
                    <a class="text-primary-foreground/80 transition-colors hover:text-primary-foreground"
                        href="#about">Quiénes Somos</a>
                    <a class="text-primary-foreground/80 transition-colors hover:text-primary-foreground"
                        href="#services">Servicios</a>
                    <a class="text-primary-foreground/80 transition-colors hover:text-primary-foreground"
                        href="#whyus">Por Qué Elegirnos</a>
                    <a class="text-primary-foreground/80 transition-colors hover:text-primary-foreground"
        ...
        <main class="flex-1">
            <section
                class="relative h-[60vh] min-h-[400px] w-full flex items-center justify-center text-primary-foreground">
                <img alt="Materiales de embalaje y empaque profesional" data-ai-hint="packaging materials"
                    decoding="async" data-nimg="fill" class="object-cover"
                    style="position:absolute;height:100%;width:100%;left:0;top:0;right:0;bottom:0;color:transparent"
                    sizes="100vw"
                    srcSet="/_next/image?url=%2Fheroimg.webp&amp;w=640&amp;q=75 640w, /_next/image?url=%2Fheroimg.webp&amp;w=750&amp;q=75 750w, /_next/image?url=%2Fheroimg.webp&amp;w=828&amp;q=75 828w, /_next/image?url=%2Fheroimg.webp&amp;w=1080&amp;q=75 1080w, /_next/image?url=%2Fheroimg.webp&amp;w=1200&amp;q=75 1200w, /_next/image?url=%2Fheroimg.webp&amp;w=1920&amp;q=75 1920w, /_next/image?url=%2Fheroimg.webp&amp;w=2048&amp;q=75 2048w, /_next/image?url=%2Fheroimg.webp&amp;w=3840&amp;q=75 3840w"
            ...
            <section id="about" class="py-16 md:py-24 bg-background" data-aos="fade-up">
                <div class="container">
                    <div class="grid lg:grid-cols-1 gap-6 lg:gap-12 items-center mb-12">
                        <div class="second-text text-center" data-aos="fade-right" data-aos-delay="100">
                            <h2 class="font-headline text-3xl font-bold tracking-tighter sm:text-4xl">¿ Quiénes
                                Somos ?
                            </h2>
                            <div id="about-content" class="flex flex-col md:flex-row gap-8 items-center">
                                <div class="w-full md:w-1/2">
                                    <p
                                        class="introduction mt-4 md:text-lg text-muted-foreground text-center md:text-left">
                                        ...
                                        nuestro
                                        inicio, nos hemos enfocado en calidad, asesoría y una atención personalizada
                                        para
                                        ayudarte a
                    ...
                    <div class="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div class="rounded-lg border bg-card text-card-foreground shadow-sm" data-aos="fade-up"
                            data-aos-delay="150">
                            <div class="flex flex-col space-y-1.5 p-6">
                                <div class="text-2xl font-semibold leading-none tracking-tight font-headline">
                                    <h3>Misión</h3>
                                </div>
                            </div>
                            <div class="valores p-6 pt-0">
                                <p class="text-muted-foreground">Proveer empaques, materiales de embalaje y
                                    soluciones
                                    logísticas con estándares de calidad, entregas confiables y asesoría dedicada,
                                    para
                                    que cada producto llegue en óptimas condiciones al cliente final.</p>
                            </div>
                        </div>
                        ...
                        <div class="rounded-lg border bg-card text-card-foreground shadow-sm" data-aos="fade-up"
                            ...
                            <div class="valores p-6 pt-0">
                                <p class="text-muted-foreground">Ser reconocidos en la región como el proveedor de
                                    referencia en embalaje, empaque y soluciones logísticas — por la calidad de
                                    nuestros
                                    productos, la eficiencia de nuestros servicios y la cercanía con nuestros
                                    clientes.
                                </p>
                            </div>
                        </div>

                        <div class="rounded-lg border bg-card text-card-foreground shadow-sm md:col-span-2 lg:col-span-1"
                                ...
                                <ul class="space-y-3">
                                    <li class="valores flex items-start" data-aos="fade-left" data-aos-delay="400">
                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                            viewBox="0 0 24 24" height="2em" width="2em"
                                        ...
                                        <div><span class="font-semibold">Calidad:</span><span
                                                class="text-muted-foreground ml-1">Productos resistentes que
                                                protegen
                                                tus envíos.</span></div>
                                    </li>
                                    <li class="valores flex items-start" data-aos="fade-left" data-aos-delay="500">
                                        ...
                                        <div><span class="font-semibold">Confianza:</span><span
                                                class="text-muted-foreground ml-1">Relación transparente con
                                                nuestros
                                                clientes.</span></div>
                                    </li>
                                    <li class="valores flex items-start" data-aos="fade-left" data-aos-delay="600">
                                        ...
                                        <div><span class="font-semibold">Agilidad:</span><span
                                                class="text-muted-foreground ml-1">Entregas rápidas y soluciones
                                                precisas.</span></div>
                                    </li>
                                    <li class="valores flex items-start" data-aos="fade-left" data-aos-delay="700">
                                        ...
                                        <div><span class="font-semibold">Asesoría:</span><span
                                                class="text-muted-foreground ml-1">Te ayudamos a elegir el empaque
                                                correcto.</span></div>
                                    </li>
                                    <li class="valores flex items-start" data-aos="fade-left" data-aos-delay="800">
                                        ...
                                        <div><span class="font-semibold">Responsabilidad:</span><span
                                                class="text-muted-foreground ml-1">Seguridad en cada envío y cuidado
                                                del
                                                producto.</span></div>
                                    </li>
                                </ul>
            ...
            <section id="services" class="py-16 md:py-24 bg-secondary" data-aos="fade-up">
                <div class="container">
                    <div class="tercer-texto text-center max-w-3xl mx-auto" data-aos="fade-up" data-aos-delay="100">
                        <h2 class="font-headline text-3xl font-bold tracking-tighter sm:text-4xl">Nuestros Servicios
                            Principales</h2>
                        <p class="introduction mt-4 md:text-lg">En Envolpaq nos especializamos en ofrecer productos de
                            embalaje, empaques y soluciones adaptadas a empresas, comercio y logística.</p>
                    </div>
                    <div class="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">

                        <div class="rounded-lg border bg-card text-card-foreground shadow-sm flex flex-col transition-all duration-300 hover:scale-105 hover:shadow-xl"
                            data-aos="fade-up" data-aos-delay="150">
                            <div class="flex space-y-1.5 p-6 flex-row items-center gap-4">
                                <div class="icons-cards bg-primary text-primary-foreground p-3 rounded-md"
                                    data-aos="zoom-in" data-aos-delay="180">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="lucide lucide-package-search h-6 w-6">
                                        <path
                                ...
                                <div class="font-semibold tracking-tight font-headline text-lg">
                                    <h4>Suministro de Materiales</h4>
                                </div>
                            </div>
                            <div class="p-6 pt-0">
                                <p class="text-muted-foreground">Suministro de empaques, cajas, film, material de
                                    protección. Amplio inventario y stock local inmediato.</p>
                            </div>
                        </div>
                        ...
                        <div class="rounded-lg border bg-card text-card-foreground shadow-sm flex flex-col transition-all duration-300 hover:scale-105 hover:shadow-xl"
                            ...
                            <div class="flex space-y-1.5 p-6 flex-row items-center gap-4">
                                <div class="icons-cards bg-primary text-primary-foreground p-3 rounded-md"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="lucide lucide-box h-6 w-6">
                                        <path
                                ...
                                <div class="font-semibold tracking-tight font-headline text-lg">
                                    <h4>Diseño y Soluciones a Medida</h4>
                                </div>
                            </div>
                            <div class="p-6 pt-0">
                                <p class="text-muted-foreground">Diseño y suministro de soluciones personalizadas de
                                    embalaje, creadas para proteger tus productos y potenciar tu marca.</p>
                            </div>
                        </div>
                        ...
                        <div class="rounded-lg border bg-card text-card-foreground shadow-sm flex flex-col transition-all duration-300 hover:scale-105 hover:shadow-xl"
                            ...
                            <div class="flex space-y-1.5 p-6 flex-row items-center gap-4">
                                <div class="icons-cards bg-primary text-primary-foreground p-3 rounded-md"
                                    data-aos="zoom-in" data-aos-delay="480">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="lucide lucide-lightbulb h-6 w-6">
                                        <path
                                            d="M15 14c.2-.7 1-1.4 1.6-2.1a2 2 0 0 0 .2-2.7c-.5-.7-1.4-1-2.1-1.4h-.5a4 4 0 0 0-4 4v.5c.7.2 1.4 1 2.1 1.6a2 2 0 0 0 2.7.2c.7-.5 1-1.4 1.4-2.1v-.5Z">
                                        </path>
                                        <path d="M20 9a8 8 0 0 0-8-8 8 8 0 0 0-8 8c0 4.418 3.582 8 8 8v4"></path>
                                        <path d="M10 21h4"></path>
                                    </svg>
                                </div>
                                <div class="font-semibold tracking-tight font-headline text-lg">
                                    <h4>Asesoría Logística Profesional</h4>
                                </div>
                            </div>
                            <div class="p-6 pt-0">
                                <p class="text-muted-foreground">Asesoría para optimizar envíos, almacenamiento y
                                    expedientes logísticos. Te ayudamos a elegir el empaque adecuado.</p>
                            </div>
                        </div>
                        ...
                        <div class="rounded-lg border bg-card text-card-foreground shadow-sm flex flex-col transition-all duration-300 hover:scale-105 hover:shadow-xl"
                            ...
                            <div class="flex space-y-1.5 p-6 flex-row items-center gap-4">
                                <div class="icons-cards bg-primary text-primary-foreground p-3 rounded-md"
                                    data-aos="zoom-in" data-aos-delay="630">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="lucide lucide-truck h-6 w-6">
                                ...
                                <div class="font-semibold tracking-tight font-headline text-lg">
                                    <h4>Entregas y Precios Competitivos</h4>
                                </div>
                            </div>
                            <div class="p-6 pt-0">
                                <p class="text-muted-foreground">Atención rápida, entregas locales confiables y precios
                                    competitivos en San Luis Potosí y la región.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="whyus" class="py-16 md:py-24 bg-background" data-aos="fade-up">
                ...
                <div class="container px-4 lg:px-6 max-w-6xl mx-auto">
                    <div class="text-center mb-8 lg:mb-12" data-aos="fade-up" data-aos-delay="100">
                        <h2 class="font-headline text-3xl font-bold tracking-tighter sm:text-4xl">¿Por qué elegir
                            Envolpaq?</h2>
                        <p class="introduction mt-4 text-muted-foreground md:text-lg text-center">Ofrecemos
                    ...
                    <div id="whyus-container" class="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
                        ...
                        <div class="w-full md:w-1/2 flex flex-col gap-6 md:gap-8 order-1 md:order-none">
                            <div id="valores" class="flex flex-col gap-6">
                                ...
                                <!-- Valor 1 -->
                                <div class="flex items-start gap-6 text-left w-full" data-aos="fade-up"
                                    data-aos-delay="100">
                                    <div class="w-8 h-8 flex-shrink-0 mt-1">
                                        <svg class="text-primary w-full h-full" width="32" height="32"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <span class="font-semibold text-lg leading-tight block break-words">Amplio
                                            inventario y stock local inmediato.</span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-6 text-left w-full" data-aos="fade-up"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <span class="font-semibold text-lg leading-tight block break-words">Asesoría
                                            profesional para escoger el empaque adecuado.</span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-6 text-left w-full" data-aos="fade-up"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <span class="font-semibold text-lg leading-tight block break-words">Servicio
                                            cercano y entregas ágiles en la zona de San Luis Potosí.</span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-6 text-left w-full" data-aos="fade-up"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <span class="font-semibold text-lg leading-tight block break-words">Soluciones
                                            creadas para proteger tus productos y potenciar tu marca.</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="compromiso"
                        class="mt-12 rounded-xl border bg-card text-card-foreground shadow-md p-6 text-center w-full max-w-4xl mx-auto"
                        ...
                        <p class="mt-4 text-sm text-primary/80 text-center">
                            <br>
            ...
            <section id="contact" class="py-16 md:py-24 bg-secondary" data-aos="fade-up">
                <div class="container">
                    <div class="grid gap-12 lg:grid-cols-2">
                        ...
                        <div class="space-y-6">
                            <div class="text-left">
                                <h2 class="font-headline text-3xl font-bold tracking-tighter sm:text-4xl">Ponte en
                                    Contacto</h2>
                                <p class="mt-4 text-muted-foreground md:text-lg">Estamos listos para ayudarte. Completa
                                    el formulario o utiliza uno de nuestros canales de contacto directo.</p>
                            </div>
                                ...
                                <div class="items-start gap-4">
                                    <div class="info-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            class="lucide lucide-map-pin h-6 w-6 text-primary mt-1">
                                            <path
                                    ...
                                    <p class="text-muted-foreground">Damián Carmona 1516, Col. Barrio de Santiago, San
                                        Luis Potosí, SLP, CP 78049.</p>
                                </div>
                                ...
                                <div class="items-start gap-4">
                                    <div class="info-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
                                            class="lucide lucide-phone h-6 w-6 text-primary mt-1">
                                            <path
                                    ...
                                    <a href="tel:4448143689"
                                        class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 underline-offset-4 hover:underline p-0 h-auto text-base text-muted-foreground">444
                                        814 3689
                                    </a>
                                ...
                                <div class="items-start gap-4">
                                    <div class="info-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
                                            class="lucide lucide-mail h-6 w-6 text-primary mt-1">
                                            <rect width="20" height="16" x="2" y="4" rx="2"></rect>
                                            <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path>
                                        </svg>
                                        <h3 class="font-semibold">Correo electrónico</h3>
                                    </div>
                                    <a href="mailto:envolpaqslp@hotmail.com"
                                ...
                                <div class="items-start gap-4">
                                    <div class="info-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
                                            class="lucide lucide-facebook h-6 w-6 text-primary mt-1">
                                ...
                                <div class="p-6">
                                    ...
                                    <form class="space-y-6" action="controllers/send_email.php" method="POST">
                                        <div class="space-y-2"><label
                                                ...
                                                placeholder="Tu nombre" id="contact-name" name="name" /></div>
                                        <div class="space-y-2"><label
                                                class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                                                for="contact-email">Email</label><input
                                                class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm"
                                                placeholder="tu@email.com" id="contact-email" name="email" /></div>
                                        <div class="space-y-2"><label
                                                class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                                                for="contact-subject">Asunto</label><input
                                                class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm"
                                                placeholder="Asunto de tu consulta" id="contact-subject"
                                                name="subject" /></div>
                                        <div class="space-y-2"><label
                                                class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                                                for="contact-message">Mensaje</label><textarea
                                                class="flex min-h-[80px] w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm"
                                                placeholder="Escribe tu mensaje aquí..." rows="5" name="message"
                                                id="contact-message"></textarea></div>
                                        <button
                                            class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 bg-accent text-primary-foreground hover:bg-accent/90 h-10 px-4 py-2 w-full"
